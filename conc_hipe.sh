...
$CONC_PATH/concuerror_mem -t my_hipe_test test \
    -f my_hipe_test.erl --wait-messages -T 2000 \
    --fail-uninstrumented \
    ...
    -D VSN=5 \
    -I $OTP_PATH/lib/hipe/*/ \
    -f $OTP_PATH/lib/hipe/{amd64,cerl,flow,icode,main,misc,regalloc,rtl}/*.erl \
       $OTP_PATH/lib/hipe/util/hipe_{digraph,timing}.erl \
       $OTP_PATH/lib/hipe/x86/hipe_x86{,_cfg,_registers}.erl \
    \
